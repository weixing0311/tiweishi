...
- (void)drawRect:(CGRect)rect {
    ...
    CGPoint center1 = CGPointMake(25, 25);  //设置圆心位置
    CGFloat radius1 = 23;  //设置半径
    CGFloat startA1 =  M_PI_4*5.7/2;  //圆起点位置
    CGFloat endA1 = M_PI_4*5.7/2 + M_PI * 2 * 0.8;  //圆终点位置
    ...
    CGContextSetLineWidth(ctx1, 4); //设置线条宽度
    [HEXCOLOR(0xffc9cd) setStroke]; //设置描边颜色
    ...
    CGFloat endA = M_PI_4*5.7/2 + M_PI * 2 * self.progressValue*0.8;  //圆终点位置
