...
{
    double itemHeight = 308 / 7;
    int width =(JFA_SCREEN_WIDTH-20);
    int yu = width%7;
    double itemWidth = (JFA_SCREEN_WIDTH-20-yu) / 7;
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0) {
        ...
        if (indexPath.row==collectionViewIndex&&indexPath.section ==1) {
            cell.dateLabel.backgroundColor = HEXCOLOR(0xeeeeee);
        }else{
            cell.dateLabel.backgroundColor = [UIColor whiteColor];
        }
    }
...
//    if (self.clickCalendarBlock) {
//        self.clickCalendarBlock(_date);
//    }
    if (indexPath.section ==1) {
