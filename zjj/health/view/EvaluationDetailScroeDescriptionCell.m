...
-(void)setUpinfoWithItem
{
    ...
    self.ageLabel.text = [NSString stringWithFormat:@"年龄：%d",[HealthDetailsItem instance].age];
    self.heightLabel.text =[NSString stringWithFormat:@"身高：%dcm",[HealthDetailsItem instance].height];
